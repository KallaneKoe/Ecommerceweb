...
if (isset($_POST['form1'])) {
    ...
    if (isset($_POST['cust_b_country'])) {
    $cust_b_country = (int)$_POST['cust_b_country'];
} else {
    $cust_b_country = 0;
}
if (isset($_POST['cust_s_country'])) {
    $cust_s_country = (int)$_POST['cust_s_country'];
} else {
    $cust_s_country = 0; // Or any default value that makes sense
}
