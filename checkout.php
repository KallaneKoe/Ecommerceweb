                        ...
                        <table class="table table-responsive table-hover table-bordered">
                            ...
                            <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format($arr_cart_p_current_price[$i]); ?> <?php echo LANG_VALUE_1; ?></td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        ?>
                                        <?php echo number_format($row_total_price); ?> <?php echo LANG_VALUE_1; ?>
                                    </td>
                                </tr>
                            <?php endfor; ?>
                            <tr>
                                <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                                <th class="total-amount"><?php echo number_format($table_total_price); ?> <?php echo LANG_VALUE_1; ?></th>
                            </tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class="total-amount"><?php echo number_format($shipping_cost); ?> <?php echo LANG_VALUE_1; ?></td>
                            </tr>
                            <tr>
                                ...
                                <th class="total-amount">
                                    ...
                                    ?>
                                    <?php echo number_format($final_total); ?> <?php echo LANG_VALUE_1; ?>
                                </th>
                            </tr>
                        </table>
                    </div>
                        ...
                        <?php else : ?>
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div>
                                        <!-- <form class="btn-momo" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="payment/momo/xulythanhtoanmomo.php" value="<?php echo $final_total; ?>">
                                            <input type="submit" name="momo" value="Thanh toán MOMO QRcode" class="btn btn-danger">
                                        </form> -->
                                        <!-- <form class="btn-momo" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="payment/momo/xulythanhtoanmomo.php">
                                        Truyền giá trị tổng tiền qua input hidden -->
                                        ...
                                        <form class="btn-momo" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="payment/momo/xulythanhtoanmomo.php">
                                                <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                                <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                                    <input type="hidden" name="product_id[]" value="<?php echo $arr_cart_p_id[$i]; ?>"> <!-- Add product_id here -->
                                                ...
                                                <input type="hidden" name="product_qty[]" value="<?php echo $arr_cart_p_qty[$i]; ?>">  
                                                <?php endfor; ?>
                                                <input type="submit" name="momo" value="Thanh toán MOMO QRcode" class="btn btn-danger">
                                        </form>
