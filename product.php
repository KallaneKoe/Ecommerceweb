...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Thêm vào giỏ hàng thành công !';
        } else {
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                <span class="price-name" style="font-size:16px;"><?php echo LANG_VALUE_54; ?></span><br>
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <?php echo number_format($p_current_price); ?><?php echo LANG_VALUE_1; ?>                                     
                                    <?php endif; ?> 
                                    <del><?php echo number_format($p_old_price); ?><?php echo LANG_VALUE_1; ?></del>
                                </span>
                            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo number_format($row['p_current_price']); ?><?php echo LANG_VALUE_1; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo number_format($row['p_old_price']); ?><?php echo LANG_VALUE_1; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
